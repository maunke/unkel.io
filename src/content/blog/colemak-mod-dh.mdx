...
[kmonad config](/kmonad-custom-splitted-colemak-mod-dh.kbd), that I am still
...
unexpected moments for around 6 months after switching.

<ImageFigure
  maxWidth={450}
  src={KeyboardImg}
  fig="12"
  caption="Splitted keyboard with reMarkable paper pro in portrait mode. All photos shown are scans of physical Instax Wide Evo prints."
/>

A very nice side effect of using a splitted keyboard is to put something to
write on between in portrait mode, such that I am writing on my
