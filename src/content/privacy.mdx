---
title: "Privacy - Markus Unkel"
description: "Privacy and tranparency information for visitors."
showToc: true
---
...
The TL;DR and transparency version:

- I do not track you on client- or server-side<br /><small>(nginx 180-days log
  rotation and http statistics via [GoAccess](//goaccess.io))</small>
- This website is hosted on [Hetzner](//hetzner.com)<br /><small>(company and
  servers located in Germany)</small>
- My Email-provider is [migadu](//migadu.com)<br /><small>(company from
  Switzerland, servers located in France)</small>

The legally binding privacy notice is written down in german below.
...
<h3>Datenerfassung auf dieser Websitebetreiber</h3>
...
<p>
  ...
  auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG,
  soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf
  Informationen im Endger&auml;t des Nutzers (z.&nbsp;B. Device-Fingerprinting)
...
<p>
  Fax: +494039903555
  <br />
  E-Mail: contact@markusunkel.tech
</p>
<p>
